/* ==========================================================================
   ...
   Generated from Finn's Coros account on 2026-09-18.
...
const LOAD = [
  ...
  { date: "2026-09-13", comment: "Decreasing", shortTerm: 5, longTerm: 42, ratio: 0.11 },
  { date: "2026-09-14", comment: "Decreasing", shortTerm: 15, longTerm: 43, ratio: 0.34 },
  { date: "2026-09-15", comment: "Decreasing", shortTerm: 13, longTerm: 42, ratio: 0.30 },
  { date: "2026-09-16", comment: "Decreasing", shortTerm: 11, longTerm: 42, ratio: 0.26 },
  { date: "2026-09-17", comment: "Decreasing", shortTerm: 10, longTerm: 42, ratio: 0.23 },
  { date: "2026-09-18", comment: "Decreasing", shortTerm: 8, longTerm: 42, ratio: 0.19 },
];
...
const TOTALS = {
  ...
  run:  { distKm: 410.4, timeHours: 40.9, count: 70, calories: 32798 },
};
...
const WEEKLY = [
  ...
  { week: "2026-W38", run: 0.68, bike: 0,    swim: 0 },
];

// Most recent sessions, newest first. No place names on purpose — this file
// is public, keep it that way in future edits too.
const RECENT = [
  { date: "2026-09-14", discipline: "run",  label: "Outdoor Run",     durationSec: 2430, distanceM: 4450,  avgHr: 146, calories: 556 },
...
const SCHEDULE = [
  { date: "2026-09-19", label: "Planned session", distanceKm: 11.36, estimatedTime: "1:23:05", loadTL: 122 },
  { date: "2026-09-20", label: "Planned session", distanceKm: 21.00, estimatedTime: "2:13:05", loadTL: 276 },
  { date: "2026-09-22", label: "Planned session", distanceKm: 11.36, estimatedTime: "1:23:05", loadTL: 122 },
  { date: "2026-09-23", label: "Planned session", distanceKm: 20.80, estimatedTime: "2:11:39", loadTL: 297 },
  { date: "2026-09-24", label: "Planned session", distanceKm: 6.00,  estimatedTime: "49:03",   loadTL: 60 },
];
